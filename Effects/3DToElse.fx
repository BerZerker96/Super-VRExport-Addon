...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void PS_InputKata(in float4 position : SV_Position, in float2 texcoord : TEXCOORD0, out float4 colorA : SV_Target0)
{	
	colorA = texcoord.x < 0.5 ? tex2D(SamplerCL,float2(texcoord.x * 2.0, texcoord.y)) : tex2D(SamplerCR,float2(texcoord.x * 2.0 - 1.0, texcoord.y));
}
